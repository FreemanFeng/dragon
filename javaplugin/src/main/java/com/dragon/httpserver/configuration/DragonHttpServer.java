package com.dragon.httpserver.configuration;

import com.dragon.httpserver.netty.iohandler.InterceptorHandler;
import com.dragon.httpserver.netty.iohandler.FilterLoggingHandler;
import com.dragon.httpserver.netty.iohandler.HttpServerHandler;
...
@Configuration
public class DragonHttpServer implements ApplicationListener<ApplicationStartedEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DragonHttpServer.class);
    ...
    public void onApplicationEvent(@NonNull ApplicationStartedEvent event) {
        ...
        ChannelFuture channelFuture = bootstrap.bind(port).syncUninterruptibly().addListener(future -> {
            String logBanner = "\n\n" +
                    ...
                    "*                                                                                   *\n" +
                    "*                                                                                   *\n" +
                    "*                   Dragon Http Server started on port {}.                        *\n" +
                    "*                                                                                   *\n" +
                    "*                                                                                   *\n" +
                    "* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *\n";
        ...
        channelFuture.channel().closeFuture().addListener(future -> {
            LOGGER.info("Dragon Http Server Start Shutdown ............");
